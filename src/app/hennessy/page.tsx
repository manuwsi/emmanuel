      ...
      <div className="pt-32 px-6 md:px-10 max-w-6xl mx-auto flex-grow space-y-24">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-ivy font-light tracking-tight text-white drop-shadow-md">
            Hennessy X.O Second Skin
          </h1>

          <h2 className="text-base md:text-lg text-gray-400 uppercase tracking-wide">
            Generative Art x UI Experience
          </h2>
          <p className="text-sm md:text-base max-w-2xl text-gray-300 leading-relaxed">
            Official project made within the agency OKCC and presented at VivaTech 2025. This limited edition of Hennessy X.O merges generative art, innovation, and craftsmanship. Each bottle features a unique and customizable design, generated by a series of algorithms crafted by French artist Florian Zumbrunn. I was in charge of designing the tablet UI allowing visitors to personalize their bottles. I also contributed to setting up 3D assets and exports for the interface.
          </p>
